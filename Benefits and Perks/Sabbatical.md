...
**TODO - Peter to add clauses around this.**
There is an expectation that employees return to work at Lattice after their sabbatical, and not use it as a soft exit from the company. We may set some policy to enforce this later.
